...
public class UIPanel : MonoBehaviour
{
	...
	// gốc has explicit get_UIPath/set_UIPath at RVA 0x1B2B494/0x1B2B4E5 — these are
	// auto-generated by the C# `string UIPath { get; set; }` property declared above
	// (line 67), so we omit the explicit method declarations here (CS0082 collision).
