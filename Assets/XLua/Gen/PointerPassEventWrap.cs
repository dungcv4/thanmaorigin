...
namespace XLua.CSObjectWrap
{
    ...
    public class PointerPassEventWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(PointerPassEvent);
			Utils.BeginObjectRegister(type, L, translator, 0, 6, 0, 0);
			
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SetParam", _m_SetParam);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new PointerPassEvent();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to PointerPassEvent constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetParam(RealStatePtr L)
        {
		    try {
                ...
                PointerPassEvent gen_to_be_invoked = (PointerPassEvent)translator.FastGetCSObj(L, 1);
                ...
                if(gen_param_count == 2&& translator.Assignable<System.Action>(L, 2)) 
                {
                    ...
                    gen_to_be_invoked.SetParam( _cb );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to PointerPassEvent.SetParam!");
